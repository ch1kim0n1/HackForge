...
echo "========================"
echo ""
echo "This demo will show you what MindCore · Forge generates."
...
const config = {
  ...
  stack: 'react-express',
  projectDescription: 'A demo hackathon project generated by MindCore · Forge',
  name: 'React + Express',
  frontend: 'react',
  backend: 'express'
};
...
console.log('✓ Generated frontend (React)');
...
console.log('✓ Generated backend (Express)');
